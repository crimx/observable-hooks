...
declare global {
  namespace jest {
    ...
    interface Matchers<R> {
       ...
       */
      toFlushAndYield(expectedYields: any[]): {
        pass: boolean;
        message?: () => any;
      };
      /**
       ...
       * 3. Compare.
       */
      toFlushAndYieldThrough(expectedYields: any[]): {
        pass: boolean;
        message?: () => any;
      };
      /**
       ...
       * 3. Collect Yields and compare.
       */
      toFlushUntilNextPaint(expectedYields: any[]): {
        pass: boolean;
        message?: () => any;
      };
      /**
       ...
       * 3. Collect Yields and compare.
       */
      toFlushExpired(expectedYields: any[]): {
        pass: boolean;
        message?: () => any;
      };
      /**
       * Compare Yields.
       */
      toHaveYielded(expectedYields: any[]): {
        pass: boolean;
        message?: () => any;
      };
      /**
